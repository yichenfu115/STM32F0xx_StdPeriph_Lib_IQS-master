...
#ifdef DEBUG_IQS316
	if ((ui8ProdNo != 0x04) || (ui8VersionNo != 0x12))  // 0x04 x012  27*1
	{
...
uint8_t IQS316_Write(uint8_t ui8Address, uint8_t *ui8Data, uint8_t ui8Length)
{
	...
	/* Configure slave address, nbytes, reload, end mode and start or stop generation */
	I2C_TransferHandling(TP_I2C, TP_SLAVE_READ_ADDRESS, ui8Length, I2C_AutoEnd_Mode, I2C_Generate_Start_Write);
